...
urlpatterns = [
    ...
    # #School APIs End Points
    # path('schools/', SchoolApiController.SchoolApiController.allSchools, name='allSchools'),
    # path('addschool/', SchoolApiController.SchoolApiController.addSchool, name='addSchool'),
    # path('getconversion/', ConversionApiController.ConversionApiController.getConversion, name='getConversion'),
    # path('getconversionrate/', ConversionApiController.ConversionApiController.getConversionRate, name='getConversionRate'),
    # path('updateconversion/', ConversionApiController.ConversionApiController.updateConversion, name='updateConversion'),
    # path('removeconversion/', ConversionApiController.ConversionApiController.removeConversion, name='removeConversion'),
    ...
    path('login/', UserApiController.UserApiController.userLogin, name='userLogin',),
    path('signup/', UserApiController.UserApiController.userSignup, name='userSignup',),
    path('selectuser/', UserApiController.UserApiController.selectUser, name='selectUser',),
    path('forgetpassword/', UserApiController.UserApiController.genUserFPCode, name='genUserFPCode',),
    path('verifyfpcode/', UserApiController.UserApiController.verifyUserFPCode, name='verifyUserFPCode',),
    path('updateforgetpassword/', UserApiController.UserApiController.updateUserForgetPassword, name='updateUserForgetPassword',),
    path('changepassword/', UserApiController.UserApiController.changeUserPassword, name='changeUserPassword',),
    path('addchild/', ChildApiController.ChildApiController.addChild, name='addChild',),
    path('allchildren/', ChildApiController.ChildApiController.allChildren, name='allChildren',),
    path('selectchild', ChildApiController.ChildApiController.selectChild, name='selectChild',),
    path('addrewardtask/', RewardTaskApiController.RewardTaskApiController.addRewardTask, name='addRewardTask',),
    path('allrewardtask', RewardTaskApiController.RewardTaskApiController.allRewardTask, name='allRewardTask',),
    path('addtransaction/', TransactionApiController.TransactionApiController.addTransaction, name='addTransaction',),
    path('alltransactions', TransactionApiController.TransactionApiController.allTransactions, name='allTransactions',),
    path('transactionssum/', TransactionApiController.TransactionApiController.selectChildTotalSumofTrans, name='transactionsSum',),
